...
<main class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/dashboard/student/{{$faculty->code}}/{{$student->batch_id}}">{{$faculty->code.$student->batch_id}}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$student->preferedname}}</li>
        </ol>
    </nav>
</main>
       ...
       <div class="col-md-4 mb-3">
           <div class="card">
               <div class="card-body">
                   <div class="d-flex flex-column align-items-center text-center">
                        <img src={{"/uploads/images/".$student->image}} alt="{{"Profile Image: ".$student->preferedname}}" style="border-radius: 10%" width="250">
                       <div class="mt-2">
           ...
           <div class="mt-3">
               <div class="d-grid gap-2 col-6 mx-auto">
                <a href="/dashboard/student/verify/{{$student->id}}" class="btn btn-primary" type="button">Verify</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="/dashboard/student/reject/{{$student->id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="pt-1">
                <label for="keyerror" class="form-label">Key Error Type</label>
                <select id="keyerror" type="keyerror" class="form-select" name="keyerror" required>
            ...
            <div class="pt-2">
                ...
                <input id='remarks' type="text" class="form-control @error('remarks') is-invalid @enderror" placeholder="Some text here" name="remarks">
                @error('remarks')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
